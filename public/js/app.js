...
//
 ...
 // error モジュールのステートを監視し、INTERNAL_SERVER_ERROR だった場合にエラーページに移動
...
通信エラーを取得するには await/catch パターンを用いましたが、API 呼び出しが増えると .catch(error => error.response || error) が重複してきます。
エラーレスポンスが返ってきた場合はエラーそのものではなくレスポンスオブジェクトを返す、という処理はどの API 呼び出しにも共通しているのでインターセプターにまとめたわけです。
*/
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              context.commit('setApiStatus', null); // 通信エラーの取得。async/await を用いて非同期処理を書くと、非同期処理が成功した場合も失敗した場合も同じ変数に結果を代入できる
...
var store = new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  modules: {
    ...
    error: _error__WEBPACK_IMPORTED_MODULE_3__["default"] // error モジュール読み込み
...
__webpack_require__(/*! /Users/kamotakeshi/develop/laravel/vuesplash/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/kamotakeshi/develop/laravel/vuesplash/resources/sass/app.scss */"./resources/sass/app.scss");
